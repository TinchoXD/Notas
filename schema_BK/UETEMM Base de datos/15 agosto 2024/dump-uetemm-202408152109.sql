...
CREATE TABLE `estudiante` (
  ...
  `estu_dato_familiar_familiares_discacidad` tinyint(1) DEFAULT NULL,
  ...
  `estu_dato_familiar_familiares_discacidad_descripcion` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`estu_id`),
...
-- Dump completed on 2024-08-15 21:09:36
