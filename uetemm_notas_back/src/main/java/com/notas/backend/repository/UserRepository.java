...
public interface UserRepository extends JpaRepository<User, Integer> {
        ...
        @Transactional
        void saveNewUser(@Param("firstname") String firstname, @Param("lastname") String lastname,
                        @Param("username") String username, @Param("password") String password,
                        @Param("user_email_personal") String user_email_personal, @Param("role") String role,
                        @Param("user_estado_usuario") int user_estado_usuario);
