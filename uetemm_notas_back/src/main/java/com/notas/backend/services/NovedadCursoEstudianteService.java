...
public class NovedadCursoEstudianteService {
     ...
     * {
     * Nota nota = notaRepository.findByEstudianteIdAndCursoProfesorId(estu_id,
     * cupr_id);
     * return nota;
     * }
     */
     ...
     * 
     * Nota nota =
     * notaRepository.findByEstudianteIdAndCursoProfesorId(notaRequest.estu_id,
     * notaRequest.cupr_id);
     * 
     * if (nota == null) {
     * nota = new Nota();
     ...
     */
    /*
     * public NotaAnimacionLectura
     * getNotaAnimacionLecturaByEstudianteIdAndCursoId(int estu_id, int curs_id) {
     * NotaAnimacionLectura nota =
     * notaAnimacionLectucaRepository.findByEstudianteIdAndCursoId(estu_id,
     * curs_id);
     * return nota;
     * }
     * 
     * @Transactional
     * public MessageResponse postNotaAnimacionLectura(NotaComplementariaRequest
     * notaRequest) {
     * 
     ...
     * 
     * return new
     * MessageResponse("La Nota Acompañamiento a la Lectura se guardó satisfactoriamente"
     * );
     * }
     */
     ...
     */
    /*
     * public NotaAcompaniamientoIntegralAula
     * getNotaAcompaniamientoIntegralByEstudianteIdAndCursoId(int estu_id,
     * int curs_id) {
     * NotaAcompaniamientoIntegralAula nota =
     * notaAcompaniamientoIntegralAulaRepository
     ...
     * postNotaAcompaniamientoIntegralAula(NotaComplementariaRequest notaRequest) {
     * 
     * NotaAcompaniamientoIntegralAula notaAcompaniamientoIntegralAula =
     * notaAcompaniamientoIntegralAulaRepository
     * .findByEstudianteIdAndCursoId(notaRequest.estu_id, notaRequest.curs_id);
     * 
     ...
     * 
     * notaAcompaniamientoIntegralAulaRepository.save(
     * notaAcompaniamientoIntegralAula);
     * 
     * return new
     * MessageResponse("La Nota Acompañamiento Integral en el Aula se guardó satisfactoriamente"
     * );
     * }
     */
     ...
     */
    /*
     * public NotaComportamiento getNotaComportamientoByEstudianteIdAndCursoId(int
     * estu_id, int curs_id) {
     * NotaComportamiento nota =
     * notaComportamientoRepository.findByEstudianteIdAndCursoId(estu_id, curs_id);
     * return nota;
     * }
     * 
     * @Transactional
     * public MessageResponse postNotaComportamiento(NotaComplementariaRequest
     * notaRequest) {
     * 
